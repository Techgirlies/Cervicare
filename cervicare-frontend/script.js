document.addEventListener('DOMContentLoaded', function () {
    ...
    // Save assessment result (optional feature)
...
// Enhanced hospital recommendations
...
// Multi-step form (Assessment Form) navigation and validation
...
// Event delegation for next/prev buttons inside the form
...
// Function to render recommendations in a table
...
// Open the appointment creation form popup/modal
function openAppointmentForm() {
    const popup = document.getElementById('appointment-form-popup');
    if (popup) popup.classList.remove('hidden');
}

// Close the appointment form popup/modal
function closeAppointmentForm() {
    const popup = document.getElementById('appointment-form-popup');
    if (popup) popup.classList.add('hidden');

    // Reset form and handlers to default create mode
...
// Bind the appointment form submit event initially for creation
document.getElementById('appointment-form').onsubmit = defaultCreateAppointment;
// Show a specific form step and update progress bar
function showStep(step) {
    formSteps.forEach((formStep, index) => {
        if (index === step) {
            formStep.classList.add("active");
...
// Event delegation for next and previous buttons inside the form
form.addEventListener("click", (e) => {
    if (e.target.matches("#next-btn")) {
        e.preventDefault();
        if (validateStep(currentStep)) {
